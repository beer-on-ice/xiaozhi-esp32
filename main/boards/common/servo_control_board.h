...
#define MQTT_SUBSCRIBE_TOPIC "esp32c6/98:A3:16:8E:88:68/data/humanDetected"
...
class ServoControlBoard {
  public:
    ...
    std::string mqtt_publish_topic_log_deviceState_ = "esp32s3/%02x:%02x:%02x:%02x:%02x:%02x/log/deviceStat";
  ...
  private:
    ...
    std::string mac_ = "98:a3:16:8f:79:74";
    ...
    /*--- 下巴 ---*/
    static constexpr uint8_t DM0_Speed_18_Position_70[10] = {0xff, 0x01, 0x00, 0x02, 0x00, 0xff, 0x02, 0x00, 0xfd, 0x04}; // 闭——限制
    static constexpr uint8_t DM0_Speed_18_Position_90[10] = {0xff, 0x01, 0x00, 0x02, 0x00, 0xff, 0x02, 0x00, 0xdc, 0x05}; // 初始
    static constexpr uint8_t DM0_Speed_18_Position_120[10] = {0xff, 0x01, 0x00, 0x02, 0x00, 0xff, 0x02, 0x00, 0x29, 0x07}; // 开——限制

    static constexpr uint8_t DM0_Speed_90_Position_75[10] = {0xff, 0x01, 0x00, 0x0a, 0x00, 0xff, 0x02, 0x00, 0x35, 0x05};
    static constexpr uint8_t DM0_Speed_90_Position_90[10] = {0xff, 0x01, 0x00, 0x0a, 0x00, 0xff, 0x02, 0x00, 0xdc, 0x05}; // 说话——闭
    static constexpr uint8_t DM0_Speed_90_Position_95[10] = {0xff, 0x01, 0x00, 0x0a, 0x00, 0xff, 0x02, 0x00, 0x4b, 0x06}; // 说话——开
    static constexpr uint8_t DM0_Speed_90_Position_100[10] = {0xff, 0x01, 0x00, 0x0a, 0x00, 0xff, 0x02, 0x00, 0xba, 0x06}; // 说话——开
